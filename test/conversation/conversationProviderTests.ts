...
export function testProvider<T>(
    getConversationProvider: () => IConversationProvider<T> | Promise<IConversationProvider<T>> | $Promise<IConversationProvider<T>>,
    providerName: string
): void {
    getConversationProvider = $Promise.promisify<IConversationProvider<T>>(getConversationProvider);
