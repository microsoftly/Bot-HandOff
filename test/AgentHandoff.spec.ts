...
describe('agent handoff', () => {
    ...
    it('can handover to agents', () => {
        ...
        return new BotTester(bot, TestDataProvider.CUSTOMER_1)
            ...
            .sendMessageToBot(
                new ConnectEventMessage(TestDataProvider.CUSTOMER_1, TestDataProvider.AGENT_1_CONVO_1),
            ...
            .sendMessageToBot(
                TestDataProvider.AGENT_1_CONVO_1_MESSAGE_1,
                TestDataProvider.getExpectedReceivedMessage(TestDataProvider.AGENT_1_CONVO_1_MESSAGE_1, TestDataProvider.CUSTOMER_1))
            .then(() => console.log('STEP 3'))
            .sendMessageToBot(
                TestDataProvider.CUSTOMER_1_MESSAGE_2,
                TestDataProvider.getExpectedReceivedMessage(TestDataProvider.CUSTOMER_1_MESSAGE_2, TestDataProvider.AGENT_1_CONVO_1)
            )
